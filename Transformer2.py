...
#visits_df = pd.read_csv(r'D:\cgon080\ML\DifferentTest\Time6m_retrain\Codes_visit1.csv')
visits_df = pd.read_csv(r'D:\cgon080\ML\Data\Features\Time0m_retrain\Codes_visit1.csv')
...
#data_folder = r"D:\cgon080\ML\DifferentTest\Time6m_retrain\DataPython"
data_folder = r"D:\cgon080\ML\Data\Features\Time0m_retrain\DataPython1"
...
#Static variables
#static_df = pd.read_csv(r'D:\cgon080\ML\DifferentTest\Time6m_retrain\Static_features.csv')
static_df = pd.read_csv(r'D:\cgon080\ML\Data\Features\Time0m_retrain\Static_features.csv')
...
hidden_size = 107 #449 for 0, 6 and 12. 451 for 36. 455 for 60. 467 for 96
...
model1 = TransformerModel(input_size_code=input_size_code, hidden_size=hidden_size, output_size=output_size, static_size=static_size, input_size_feature = input_size_feature,
...
plt.legend()
plt.savefig(r'D:\cgon080\ML\Data\Features\Time0m_retrain\loss_plot.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.legend()
plt.savefig(r'D:\cgon080\ML\Data\Features\Time0m_retrain\Acc_plot.png', dpi=300, bbox_inches='tight')
plt.close()

torch.save(model1.state_dict(), r'D:\cgon080\ML\Data\Features\Transf_PE_0m.pth')
